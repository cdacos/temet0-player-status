...
execute unless score @s afkDis.x2 = @s afkDis.x1 at @s run function player_status:dimen_in
execute unless score @s afkDis.y2 = @s afkDis.y1 at @s run function player_status:dimen_in
execute unless score @s afkDis.z2 = @s afkDis.z1 at @s run function player_status:dimen_in
