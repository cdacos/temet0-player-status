...
execute unless score @s afkDis.y2 = @s afkDis.y1 at @s run scoreboard players set @s afkDis.lr 0
...
execute if score @s afkDis.isAFK matches 0 at @s run function player_status:dimen_in
